...
Welcome to the **Automation** repository — a centralized hub for scripts, bots, and tools designed to automate repetitive tasks, streamline workflows, and boost productivity.
...
This repository contains a collection of automation tools and scripts developed to:
...
<table align="center" style="border-collapse: separate; border-spacing: 10px; width: 60%;">
  <tr>
    <td align="center" style="background: #111; padding: 20px; border-radius: 10px; border: 1px solid #25D366">
